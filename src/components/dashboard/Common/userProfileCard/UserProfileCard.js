        ...
        <div className="jr-card text-center">
            <div className={`jr-card-header-color ${headerStyle}`}>
                <div className="jr-card-header-top">
                    <IconButton className="jr-fs-lg text-white" aria-label="Menu"><i
                        className="zmdi zmdi-menu"/></IconButton>
                    <IconButton className="icon-btn p-1 text-white ml-auto"><i
                        className="zmdi zmdi-more-vert"/></IconButton>
                </div>
            ...
            <div className="jr-card-body pt-2">
                <p className="card-text">Cenas in erat accumsan, hendrerit lorem vel, pulvinar odio. Quisque eu
                    conva.</p>
            </div>
        </div>
    )
